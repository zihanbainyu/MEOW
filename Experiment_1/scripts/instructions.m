...
function instructions(p, instruction_type)
    ...
    switch instruction_type
        ...
        case 'welcome'
            DrawFormattedText(p.window, ['Welcome to our memory research study!\n\n' ...
                'Thank you for participating.\n\n',], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);

            DrawFormattedText(p.window, ['This experiment has 4 blocks. Each block has three parts:\n\n' ...
                'Part A (1-Back) Task\n\n', ...
                'Rest period\n\n', ...
                'Part B (2-Back) Task\n\n', ...
                '\n\n', ...
                'We will record your eye movements while you do Part A and Part B.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
        ...
        case 'calibration'
            DrawFormattedText(p.window, ['Before any further instructions, we need to calibrate the eye-tracker.\n\n' ...
                '\n\n', ...
                'Please sit comfortably and keep your head still.\n\n' ...
                'In the next few screens, there will be dots on the screen.\n\n' ...
                'Follow the dot naturally with your eyes. Look right at the center of each dot when it appears.\n\n' ...
                'Keep looking at it until it disappears.\n\n' ...
                '  \n\n' ...
        ...
        case 'encoding'
            ...
            DrawFormattedText(p.window, ['Part A (1-Back)\n\n' ...
                '\n\n' ...
            ...
            DrawFormattedText(p.window, ['You have three possible responses:\n\n' ...
                '\n\n' ...
                'Press  ' p.keys.same '  (SAME)  with your index finger if the image is exactly the same as the one just before it.\n\n' ...
                'Press  ' p.keys.diff '  (SIMILAR) with your middle finger if the image is similar but not identical to the one just before it.\n\n' ...
        ...
        case 'memory'
            ...
            % Task Overview Screen 1
            DrawFormattedText(p.window, ['Part B (2-Back)\n\n' ...
                '\n\n' ...
            ...
            DrawFormattedText(p.window, ['Therefore, the response rules now are:\n\n' ...
                ...
                'Do not press any key if the image is completely new (NEW).\n\n' ...
                '\n\n' ...
                'Important: If an image repeats or resembles from only one trial ago, do nothing!\n\n' ...

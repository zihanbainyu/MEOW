    ...
    switch instruction_type
        ...
        case '1_back'
            ...
            DrawFormattedText(p.window, ['1-Back Task\n\n' ...
                '\n\n' ...
                'In this task, you will view images of everyday items, one after another.\n\n' ...
                'Your task is to compare each image to the image from ONE TRIAL AGO.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            DrawFormattedText(p.window, ['You have three possible responses:\n\n' ...
                '\n\n' ...
                'Press  ' p.keys.same '  (SAME) if the image is exactly the same as 1 trial ago.\n\n' ...
                'Press  ' p.keys.diff '  (SIMILAR) if the image is similar but not identical to 1 trial ago.\n\n' ...
                'Do NOT press any key if the image is completely different (NEW) from 1 trial ago.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            TEXT_OFFSET_CAPTION = 225;  % Caption height below center
            ...
            DrawFormattedText(p.window, ['Please pay close attention to each image!\n\n', ...
        ...
        case '2_back'
            ...
            DrawFormattedText(p.window, ['2-Back Task\n\n' ...
                ...
                'Your task is now to compare each image to the image from TWO TRIALS AGO.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            DrawFormattedText(p.window, ['Therefore, the response rules now are:\n\n' ...
                '\n\n' ...
                'Press  ' p.keys.same '  (SAME) if the image is exactly the same as 2 trials ago.\n\n' ...
                'Press  ' p.keys.diff '  (SIMILAR) if the image is similar but not identical to 2 trials ago.\n\n' ...
                'Do NOT press any key if the image is completely different (NEW) from 2 trials ago.\n\n' ...
                '\n\n' ...
                'Important: If an image repeats or resembles the one from only 1 trial ago, do nothing!\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            TEXT_OFFSET_Y       = 200;  % Label height above center
            TEXT_OFFSET_CAPTION = 225;  % Caption height below center
            ...
            DrawFormattedText(p.window, 'Current image', X_RIGHT - 40, Y_LABEL, [200 0 0]); % Red to highlight
            ...
            DrawFormattedText(p.window, 'Current image', X_RIGHT - 40, Y_LABEL, [200 0 0]);

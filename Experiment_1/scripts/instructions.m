...
function instructions(p, instruction_type)
    ...
    switch instruction_type
        ...
        case 'welcome'
            ...
            DrawFormattedText(p.window, ['This session has 4 blocks. Each block has three parts:\n\n' ...
                'Part A Task\n\n', ...
                'Rest period\n\n', ...
                'Part B Task\n\n', ...
                '\n\n', ...
        ...
        case 'encoding'
            ...
            DrawFormattedText(p.window, ['Part A (1-Back)\n\n' ...
                ...
                'Your task is to compare each image to the one that came JUST BEFORE it.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
        ...
        %==================================================================
            end_text = 'You have completed the main experiment.\n\nThank you very much for your time and effort!\n\nPlease find the experimenter.';

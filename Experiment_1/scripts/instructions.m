    ...
    switch instruction_type
        ...
        case 'welcome'
            ...
            DrawFormattedText(p.window, [
                ...
                'Phase 1: Eight short blocks of tasks\n\n' ...
                'Phase 2: One memory task\n\n\n\n' ...
        ...
        case '1_back'
            ...
            DrawFormattedText(p.window, ['1-Back Task\n\n' ...
                '\n\n' ...
                'In this task, you will view a series of everyday items, one after another.\n\n' ...
                'Your task is to compare each item to the one from ONE TRIAL AGO.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);

            % Fixation Cross Screen 4
            DrawFormattedText(p.window, ['Before each item, you will see a fixation cross.\n\n' ...
            ...
            DrawFormattedText(p.window, ['You have three possible responses:\n\n' ...
                '\n\n' ...
                'Press  ' p.keys.same '  (SAME)  with your index finger if the item is exactly the same as the one from one trial ago.\n\n' ...
                'Press  ' p.keys.diff '  (SIMILAR) with your middle finger if the item is similar but not identical to the one from one trial ago.\n\n' ...
                'Do not press any key if the item is completely new (NEW).\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            DrawFormattedText(p.window, 'Previous Item', X_LEFT_ENC - 50, Y_ROW1_LABEL, p.colors.black);
            DrawFormattedText(p.window, 'Current Item', X_RIGHT_ENC - 50, Y_ROW1_LABEL, p.colors.black);
            ...
            % ========================================================================
            % --- Labels ---
            DrawFormattedText(p.window, 'Previous Item', X_LEFT_ENC - 50, Y_ROW2_LABEL, p.colors.black);
            DrawFormattedText(p.window, 'Current Item', X_RIGHT_ENC - 50, Y_ROW2_LABEL, p.colors.black);
            ...
            DrawFormattedText(p.window, ['Please respond as quickly and accurately as you can.\n\n' ...
                'Please keep your eyes on the fixation cross (+) between items.\n\n' ...
                '\n\n' ...
        ...
        case '2_back'
            ...
            DrawFormattedText(p.window, ['2-Back Task\n\n' ...
                ...
                'Your task is now to compare each item to the one from TWO TRIALS AGO.\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            DrawFormattedText(p.window, ['Therefore, the response rules now are:\n\n' ...
                '\n\n' ...
                'Press  ' p.keys.same '  (SAME) with your index finger if the item is exactly the same as the one from two trials ago.\n\n' ...
                'Press  ' p.keys.diff '  (SIMILAR) with your middle finger if the item is similar but not identical to the one from two trials ago.\n\n' ...
                'Do not press any key if the item is completely new (NEW).\n\n' ...
                '\n\n' ...
                'Important: If an item repeats or resembles the one from only one trial ago, do nothing!\n\n'], ...
                'center', 'center', p.colors.black, [], [], [], line_spacing);
            Screen('Flip', p.window);
            waitForKeyPress(p, start_key, escape_key);
            ...
            DrawFormattedText(p.window, 'Previous Item', X_CENTER - 50, Y_ROW1_LABEL, p.colors.black); 
            DrawFormattedText(p.window, 'Current Item', X_RIGHT - 50, Y_ROW1_LABEL, p.colors.black); 
            ...
            % --- Instruction text (Caption) ---
            DrawFormattedText(p.window, ['You would press  ' p.keys.same '  because it is exactly the SAME as the item two trials ago.'], ...
            ...
            DrawFormattedText(p.window, 'Previous Item', X_CENTER - 50, Y_ROW2_LABEL, p.colors.black);
            DrawFormattedText(p.window, 'Current Item', X_RIGHT - 50, Y_ROW2_LABEL, p.colors.black);
            ...
            % --- Instruction text (Caption) ---
            DrawFormattedText(p.window, ['You would press  ' p.keys.diff '  because it is SIMILAR to the item two trials ago, but not identical.'], ...

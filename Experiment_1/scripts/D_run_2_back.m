...
DrawFormattedText(p.window, ...
    ...
    '2-Back Task', ...
    '\n\n\n', ...
    'Reminder: Compare each image against the one from TWO TRIALS AGO.', ...
    '\n\n\n', ...
    'Press ' p.keys.same ' = SAME.\n\n' ...
    'Press ' p.keys.diff ' = SIMILAR.\n\n' ...
    'No press = NEW.' ...
    '\n\n\n\n' ...
    'Please place your index and middle fingers on j and k, press f to begin'], 'center', 'center', p.colors.black);

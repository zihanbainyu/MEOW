...
% ========================================================================
%------------------------------------------------------------------
% 2A: Start of Run Screen
%------------------------------------------------------------------
DrawFormattedText(p.window, ...
    ['Part 2:  Memory Test\n\n\n\n' ...
    'For each object, decide whether it is OLD, SIMILAR, or NEW.', ...
    '\n\n\n\n' ...
    'Index finger = OLD.     Middle finger = SIMILAR.     No press = NEW.' ...
    '\n\n\n\n' ...
    'Each object stays on screen briefly, then a blank screen follows.' ...
    '\n\n\n\n' ...
    'Respond as soon as you have decided. You may answer while the object is' ...
    '\n' ...
    'on screen or during the blank, but before the next object appears.' ...
    '\n\n\n\n' ...

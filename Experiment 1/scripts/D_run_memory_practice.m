function [practice_results] = D_run_memory_practice(p, practice_schedule)
%==========================================================================
...
% Author: Zihan Bai
    ...
    DrawFormattedText(p.window, ...
        ['Practice Round: 2-Back Memory Task\n\n' ...
        '\n\n' ...
        'You will view a series of items, one after another.\n\n' ...
        'Your task is to compare each item to the one from two trials ago.\n\n' ...
        '\n\n' ...
        'Press j (repeat) if the item is exactly the same as the one from two trials ago.\n\n' ...
        'Press k (similar) if the item is similar but not identical as the one from two trials ago.\n\n' ...
        'Do not press any key if the item is completely new.\n\n' ...
        '\n\n' ...
        'You are always comparing the current image to the one from two trials ago.\n\n' ...
    ...
    try
        filename = sprintf('sub%03d_mem_practice.mat', p.subj_id);

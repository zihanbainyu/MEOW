function C_run_1_back_practice(p)
    ...
    for i = 1:nTrials
        ...
        stim_onset = Screen('Flip', p.window, fix_onset + sequence_1_back_practice.fix_duration(i) - 0.5*p.ifi, 1);
...
function [sequence_1_back_practice] = gen_1_back_practice(p)
    ...
    % 1-back practice (15 trials): 3 same (A-A), 3 similar (A-B), 3 foils, spaced
    % so response pairs are separated. Uses prac objects 1-9 (2-back uses 10-18).
    % prac_example_images('1back') shows A(1) [same] and A(2)/B(2) [similar].
    seq = { ...
        A_names(7),  "foil",    "A", "none"; ...
        A_names(1),  "same",    "A", "none"; ...
        A_names(1),  "same",    "A", "1";    ...
        A_names(2),  "similar", "A", "none"; ...
        B_names(2),  "similar", "B", "2";    ...
        A_names(8),  "foil",    "A", "none"; ...
        A_names(3),  "same",    "A", "none"; ...
        A_names(3),  "same",    "A", "1";    ...
        A_names(4),  "similar", "A", "none"; ...
        B_names(4),  "similar", "B", "2";    ...
        A_names(5),  "same",    "A", "none"; ...
        A_names(5),  "same",    "A", "1";    ...
        A_names(9),  "foil",    "A", "none"; ...
        A_names(6),  "similar", "A", "none"; ...
        B_names(6),  "similar", "B", "2"     ...
    };
